 ...
 * @author Raven
 */
public class MenuScollBar extends BasicScrollBarUI {
    ...
    private class ScrollButton extends JButton {
        ...
        public ScrollButton(int orientation, boolean isIncrease) {
            ...
            arrow = new MenuScoll().getRoundedGeneralPathFromPoints(points, scrollSize * 0.5f);
