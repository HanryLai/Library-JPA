...
//        layered.add(jPanel2,JLayeredPane.PALETTE_LAYER);
//        layered.add(jPanel4,JLayeredPane.PALETTE_LAYER);
//        layered.add(jPanel5,JLayeredPane.PALETTE_LAYER);
//        layered.add(menuScrollPane1,JLayeredPane.MODAL_LAYER);
//        layered.add(jPanel1,JLayeredPane.MODAL_LAYER);
//        setAlwaysOnTop(true);
        setResizable(false);
        setTitle("Tổng quan");
...
//        NhanVien nv = dao_nv.getNVTheoMa("");
        chonMenu();
        // F1----------
//        InputMap inputMap1 = jLabel3.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);
//        inputMap1.put(KeyStroke.getKeyStroke("ESC"), "doSomething1");
//
...
//        };
//
//        jLabel3.getActionMap().put("doSomething1", action1);
        //---------------
            ...
            public void selected(int index, int subIndex) throws Exception {
                if (index == 0) {
                    ...
                    if (gui.FrmLogin.tenDN.startsWith("TN")) {
                        ...
                        System.out.println("Value of tenDN 2: " + gui.FrmLogin.tenDN);
                        try {
                            showForm(new FrmXemBaoCao());
                        } catch (SQLException ex) {
                            Logger.getLogger(FrmChinh.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
...
//        cell = row.createCell(0, CellType.STRING); cell.setCellValue("STT");
//        cell = row.createCell(1, CellType.STRING); cell.setCellValue("10");
//        cell = row.createCell(2, CellType.STRING); cell.setCellValue("TITLE");
//        cell = row.createCell(3, CellType.STRING); cell.setCellValue("PRICES");
//        for (int i=0; i<arr.size(); i++) 
//        {
//            Modelbook book = arr.get(i); (*)
//            row = sheet.createRow(4+i);
//            cell = row.createCell(0, CellType.NUMERIC); cell.setCellValue(i+1);
//            cell = row.createCell(1, CellType.STRING); cell.setCellValue(arr.get(i).getId());
//            cell = row.createCell(2, CellType.STRING): cell.setCellValue(arr.get(i).getTitle());
//            cell = row.createCell(3, CellType.STRING): cell.setCellValue(arr.get(i).getPrice());
//        }
...
//        }
    ...
    private void initComponents() {
        ...
        pnlBotLeft1 = new javax.swing.JPanel();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconMenu/open-book1.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconMenu/nha-sach-tribook.jpg"))); // NOI18N
...
//        showPanelChange(pnlCenter,pnlCenterInit);
    ...
    private javax.swing.JPanel pnlBotLeft1;
